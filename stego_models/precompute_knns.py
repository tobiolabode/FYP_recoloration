...
@hydra.main(config_path="configs", config_name="train_config_custom_ver.yml")
            ...
            for dataset_name in dataset_names:
                ...
                if not os.path.exists(feature_cache_file):
                    ...
                    dataset = ContrastiveSegDataset(
                        ...
                        cfg=cfg,
                    ) # error here: /datadrive/pytorch-data/nns\nns_vit_small_cocostuff27_val_five_224.npz not found
