...
# from stego_segmentation import my_app 
...
class LitUnsupervisedSegmenter(pl.LightningModule):
    ...
    def train_and_save_model(model, data_loader, optimizer, config, checkpoint_dir):
        # Create a PyTorch Lightning Trainer object
        trainer = pl.Trainer(max_epochs=config.epochs, gpus=config.gpus, logger=False)
        # Train the model
...
def my_app_custom(self,img,mode_unsupervised = True,cmp=False):
    with torch.no_grad():
...
LitUnsupervisedSegmenter.train_and_save_model()
