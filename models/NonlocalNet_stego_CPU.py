...
class CorrelationLayer(nn.Module):
    ...
    def forward(self, x1, x2, alpha=1, raw_output=False, metric="similarity"):
        ...
        cv = torch.zeros(shape).to(torch.device("cpu"))
...
class WarpNet(nn.Module):
    ...
    def __init__(self, batch_size):
        ...
        self.theta_class = nn.Linear(256,256) #  CUDA error here, likely labels mismatch
        self.phi_class = nn.Linear(256,256) # 256, 256 
