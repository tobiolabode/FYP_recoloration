...
# from skimage.measure.simple_metrics import compare_psnr # error here
from skimage.metrics import peak_signal_noise_ratio
#from skimage.metrics import peak_signal_noise_ratio as psnr
#skimage.metrics.structural_similarity
# from skimage.measure import compare_ssim # error here
from skimage.metrics import structural_similarity # error here
cv2.setNumThreads(0)
...
def batch_psnr(img, imgclean, data_range):
	...
	psnr += peak_signal_noise_ratio(imgclean, img, \
