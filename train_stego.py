...
parser.add_argument("--data_root_imagenet", default="./dataset/coco-2017/", type=str)	
...
def resume_model():									   #继续学习 ，加载参数
    ...
    if opt.resume_iter:
        ...
        nonlocal_net.load_state_dict(torch.load(new_checkpoint)) # error here:  RuntimeError: Error(s) in loading state_dict for WarpNet:
