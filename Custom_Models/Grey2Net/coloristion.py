...
class ColorizationModel(MainModel):
    ...
    def __init__(self, opt):
        ...
        self.visual_names = ['real_A_l_0', 'real_A_rgb', 'real_R_rgb', 'fake_R_rgb', 'mask_gray']
    ...
    def compute_visuals(self):
        ...
        self.mask_gray = cv2.resize(self.tensor2gray(self.mask), (self.real_A_rgb.shape[1], self.real_A_rgb.shape[0]), interpolation=cv2.INTER_LINEAR)
